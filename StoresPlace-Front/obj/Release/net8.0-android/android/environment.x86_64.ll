...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 724, ; uint32_t number_of_dso_cache_entries (0x2d4)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [724 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.112_name, ; name: libaot-System.Threading.Channels.dll.so
		ptr null; void* handle (0x0)
	}, ; 1
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.94_name, ; name: libaot-System.Net.WebClient.dll.so
		ptr null; void* handle (0x0)
	}, ; 15
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.68_name, ; name: libaot-System.ComponentModel.EventBasedAsync.dll.so
		ptr null; void* handle (0x0)
	}, ; 24
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 775742236428353530, ; hash 0xac3fd7437943ffa, from name: libaot-StoresLand-API.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresLand-API.dll.so
		ptr null; void* handle (0x0)
	}, ; 30
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 849072529984616492, ; hash 0xbc882f7aa46782c, from name: aot-StoresLand-API.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresLand-API.dll.so
		ptr null; void* handle (0x0)
	}, ; 32
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.9_name, ; name: libaot-StoresPlace-Front.dll.so
		ptr null; void* handle (0x0)
	}, ; 37
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.36_name, ; name: libaot-Xamarin.AndroidX.Browser.dll.so
		ptr null; void* handle (0x0)
	}, ; 74
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.109_name, ; name: libaot-System.Text.Encodings.Web.dll.so
		ptr null; void* handle (0x0)
	}, ; 86
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.92_name, ; name: libaot-System.Net.ServicePoint.dll.so
		ptr null; void* handle (0x0)
	}, ; 105
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3394606875376903466, ; hash 0x2f1c10f7bef0652a, from name: libaot-StoresLand-API
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresLand-API.dll.so
		ptr null; void* handle (0x0)
	}, ; 134
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.27_name, ; name: libaot-SendGrid.dll.so
		ptr null; void* handle (0x0)
	}, ; 145
	%struct.DSOCacheEntry {
		i64 3610052191230710096, ; hash 0x32197b574eed5150, from name: StarkbankEcdsa
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.32_name, ; name: libaot-StarkbankEcdsa.dll.so
		ptr null; void* handle (0x0)
	}, ; 146
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 4434076950581535796, ; hash 0x3d89017e6a28e434, from name: StoresLand-API.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresLand-API.dll.so
		ptr null; void* handle (0x0)
	}, ; 174
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.86_name, ; name: libaot-System.Net.Mail.dll.so
		ptr null; void* handle (0x0)
	}, ; 217
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.110_name, ; name: libaot-System.Text.Json.dll.so
		ptr null; void* handle (0x0)
	}, ; 289
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 11671273081730159081, ; hash 0xa1f8b107e11ad1e9, from name: StoresLand-API
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresLand-API.dll.so
		ptr null; void* handle (0x0)
	}, ; 462
	...
	%struct.DSOCacheEntry {
		i64 11976350333089276798, ; hash 0xa6348b2cad6ae37e, from name: aot-StoresLand-API
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresLand-API.dll.so
		ptr null; void* handle (0x0)
	}, ; 474
...
@.env.3 = private unnamed_addr constant [37 x i8] c"e56a2b27-4106-42f0-8009-42ca6f0a852b\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [29 x i8] c"libaot-StoresLand-API.dll.so\00", align 16
@.DSOCacheEntry.9_name = private unnamed_addr constant [32 x i8] c"libaot-StoresPlace-Front.dll.so\00", align 16
...
@.DSOCacheEntry.27_name = private unnamed_addr constant [23 x i8] c"libaot-SendGrid.dll.so\00", align 16
...
@.DSOCacheEntry.32_name = private unnamed_addr constant [29 x i8] c"libaot-StarkbankEcdsa.dll.so\00", align 16
...
@.DSOCacheEntry.36_name = private unnamed_addr constant [39 x i8] c"libaot-Xamarin.AndroidX.Browser.dll.so\00", align 16
...
@.DSOCacheEntry.68_name = private unnamed_addr constant [52 x i8] c"libaot-System.ComponentModel.EventBasedAsync.dll.so\00", align 16
...
@.DSOCacheEntry.86_name = private unnamed_addr constant [30 x i8] c"libaot-System.Net.Mail.dll.so\00", align 16
...
@.DSOCacheEntry.92_name = private unnamed_addr constant [38 x i8] c"libaot-System.Net.ServicePoint.dll.so\00", align 16
@.DSOCacheEntry.93_name = private unnamed_addr constant [33 x i8] c"libaot-System.Net.Sockets.dll.so\00", align 16
@.DSOCacheEntry.94_name = private unnamed_addr constant [35 x i8] c"libaot-System.Net.WebClient.dll.so\00", align 16
...
@.DSOCacheEntry.109_name = private unnamed_addr constant [40 x i8] c"libaot-System.Text.Encodings.Web.dll.so\00", align 16
@.DSOCacheEntry.110_name = private unnamed_addr constant [31 x i8] c"libaot-System.Text.Json.dll.so\00", align 16
@.DSOCacheEntry.111_name = private unnamed_addr constant [45 x i8] c"libaot-System.Text.RegularExpressions.dll.so\00", align 16
@.DSOCacheEntry.112_name = private unnamed_addr constant [40 x i8] c"libaot-System.Threading.Channels.dll.so\00", align 16
