...
@dso_cache = dso_local local_unnamed_addr global [724 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 29077462, ; hash 0x1bbafd6, from name: libaot-StoresLand-API.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 193800745, ; hash 0xb8d2a29, from name: aot-StoresLand-API
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresLand-API.dll.so
		ptr null; void* handle (0x0)
	}, ; 28
	...
	%struct.DSOCacheEntry {
		i64 1157397433, ; hash 0x44fc7bb9, from name: StoresLand-API
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresLand-API.dll.so
		ptr null; void* handle (0x0)
	}, ; 178
	...
	%struct.DSOCacheEntry {
		i64 1361177196, ; hash 0x5121ea6c, from name: libaot-StoresLand-API
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresLand-API.dll.so
		ptr null; void* handle (0x0)
	}, ; 213
	...
	%struct.DSOCacheEntry {
		i64 1549732436, ; hash 0x5c5f0a54, from name: StoresLand-API.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresLand-API.dll.so
		ptr null; void* handle (0x0)
	}, ; 260
	...
	%struct.DSOCacheEntry {
		i64 2323604939, ; hash 0x8a7f65cb, from name: aot-StoresLand-API.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-StoresLand-API.dll.so
		ptr null; void* handle (0x0)
	}, ; 392
